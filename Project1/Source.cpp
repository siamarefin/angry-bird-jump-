...
int main()
{
	sf::RenderWindow window(sf::VideoMode(500, 700), "angry bird  Jump", sf::Style::Close); // it can't be resize
	window.setFramerateLimit(60);
	sf::Texture backgroundTexture;
	sf::Texture playerTexture;
	sf::Texture platformTexture;
	backgroundTexture.loadFromFile("images/background.png");
	playerTexture.loadFromFile("images/angrybirds_60x60.png");
	...
	*/
	...
	gameoverBackground.setFillColor(sf::Color::Green);
	...
	gameoverText.setString("Innanillah!");
